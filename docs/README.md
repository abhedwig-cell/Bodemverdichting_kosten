...
For the project-wide continuation surface, see [`49_project_effect_pathway_matrix_v0_1.md`](49_project_effect_pathway_matrix_v0_1.md). The companion source-ensemble rules are in [`50_evidence_ensemble_protocol_v0_1.md`](50_evidence_ensemble_protocol_v0_1.md). The first concrete on-site source migration is documented in [`51_onsite_ensemble_source_migration_v0_1.md`](51_onsite_ensemble_source_migration_v0_1.md). The first calculation-ready but deliberately data-gated surface is [`52_onsite_bounded_calculation_surface_v0_1.md`](52_onsite_bounded_calculation_surface_v0_1.md). Its crop-crosswalk and economic-input routes are documented in [`53_onsite_crop_and_valuation_input_routes_v0_1.md`](53_onsite_crop_and_valuation_input_routes_v0_1.md).
