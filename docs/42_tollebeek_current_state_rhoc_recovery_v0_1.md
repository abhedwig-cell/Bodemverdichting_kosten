...
Canonical reconciliation baseline: `603016278a25aae406e4414ffbd8b1d9e89c3d65`
...
The review is deliberately separate from the WER3382/Flevo-land-in-beweging acquisition route. Shared authorship is not dataset provenance.
...
Therefore this dataset remains a separate experiment/source, notwithstanding overlap in authorship with the Flevoland compaction work.
...
## 6. Relationship to newer canonical CURRENT-state work

While this workunit was executing, canonical `main` advanced with:

- the qualified WER3382 source-holder access route;
- DOI/public-metadata recovery;
- classification of a distinct 2018 `RAAK.PRO02.021` point-scale compaction dataset.

Those changes do not make the RhoC dataset OT.02 evidence and do not change its provenance. Conversely, this RhoC review does not replace or weaken those newer routes.

The authoritative next route remains the source-holder request for the 2020–2021 WER3382/Flevo-land measurement records or a stable source-native dataset identifier.

## 7. Scientific usability
...
The direct WER3382/Flevo-land raw point-data request remains the active route because that campaign is documented as having GPS-linked measurements and the required spatial assignment cannot be reconstructed from this RhoC dataset.
